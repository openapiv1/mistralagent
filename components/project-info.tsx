...
export const DeployButton = () => {
  return (
    <Link
      target="_blank"
      href={`https://vercel.com/new/clone?project-name=AI+SDK+Computer+Use+Demo&repository-name=ai-sdk-computer-use&repository-url=https%3A%2F%2Fgithub.com%2Fopenapiv1%2Fmistralagent&demo-title=AI+SDK+Computer+Use+Demo&demo-url=https%3A%2F%2Fmistralagent.vercel.app%2F&demo-description=A+chatbot+application+built+with+Next.js+demonstrating+Mistral+AI%27s+mistral-medium-2505+computer+use+capabilities&env=MISTRAL_API_KEY,E2B_API_KEY`}
